...
import glob
prefix_length = 10
test_image_dir="uit/test"# change image dir for dataset
model_path = "weights_uit/nmt-016.pt"
...
for filename in tqdm(sorted(glob(test_image_dir+"/*"))):
    ...
    with torch.no_grad():
        ...
        generated_text_prefix = generate_beam(model, tokenizer, embed=prefix_embed, temperature=1, beam_size=10)[0]
...
with open("results_uit_test_30_clipcap.json", "w",encoding="utf-8") as f:
    json.dump(out, f, ensure_ascii=False, indent=4)
    # zip -9r submission.zip results.json
# # #sample = json.load(open("vietcap4h-public-test/sample_submission.json", "r"))
# import json 
# sample=json.load(open("vietcap4h-private-test/sample_submission.json", "r"))
# for i in sample:
